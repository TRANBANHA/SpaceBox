...
@section('content')
    <div class="box-form-add">
        <form class="form-addUser flex-col" action="{{ route('admin.addRoomAction') }}" method="POST">
            @csrf
            <div class="box-ip flex-col">
                <h3>Thêm phòng chat mới</h3>
            </div>
            <div class="box-ip flex-col">
                <input class="ip-add" type="text" id="username" name="username" placeholder="Nhập tên group" required>
            </div>
            <div class="box-ip flex-col">
